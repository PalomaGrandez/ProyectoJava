...
public class frmReProImporTotal extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmReProImporTotal frame = new frmReProImporTotal();
	...
	public frmReProImporTotal() {
		...
		{
			lblNewLabel_2 = new JLabel("Importe Total");
			lblNewLabel_2.setFont(new Font("Tahoma", Font.BOLD, 16));
			lblNewLabel_2.setBounds(215, 46, 114, 20);
